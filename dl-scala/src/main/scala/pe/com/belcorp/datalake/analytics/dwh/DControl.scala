...
class DControl(val schema: String, val sourceSchema: String) extends OldTable
  ...
  override val updatePath: String =
    "pe/com/belcorp/datalake/resources/analytics/dwh/DControl/update.sql"
  override val name: String = "ctr_cierre_planit"
