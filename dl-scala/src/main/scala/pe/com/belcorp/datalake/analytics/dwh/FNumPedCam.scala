...
class FNumPedCam(val schema: String, val sourceSchema: String, override val campaigns: Seq[String]) extends OldTable
  ...
  override val updatePath: String =
    "pe/com/belcorp/datalake/resources/analytics/dwh/FNumPedCam/update.sql"
  override val name: String = "dwh_fnumpedcam"
