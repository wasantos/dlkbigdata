...
class DOrigenPedidoWeb(val schema: String, val sourceSchema: String) extends OldTable
  ...
  override val updatePath: String =
    "pe/com/belcorp/datalake/resources/analytics/dwh/DOrigenPedidoWeb/update.sql"
  override val name: String = "dwh_dorigenpedidoweb"
  override val primaryKeys: Seq[String] = Seq(
    "CODPAIS", "ORIGENPEDIDOWEB")
