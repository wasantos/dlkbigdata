...
class DStatusFacturacion(val schema: String, val sourceSchema: String, override val campaigns: Seq[String])
  ...
  override val updatePath: String =
    "pe/com/belcorp/datalake/resources/analytics/dwh/DStatusFacturacion/update.sql"
  override val name: String = "dwh_dstatusfacturacion"
  override val primaryKeys: Seq[String] = Seq(
    "CODPAIS", "ANIOCAMPANA", "CODREGION", "CODZONA")
