...
class FPedidoWebDetalle(val schema: String, val sourceSchema: String, override val campaigns: Seq[String])
  ...
  override val updatePath: String =
    "pe/com/belcorp/datalake/resources/analytics/dwh/FPedidoWebDetalle/update.sql"
  override val name: String = "dwh_fpedidowebdetalle"
