...
class DProducto(val schema: String, val sourceSchema: String) extends OldTable with OverwriteUpdate {
  ...
  override val updatePath: String =
    "pe/com/belcorp/datalake/resources/analytics/dwh/DProducto/update.sql"
  override val name: String = "dwh_dproducto"
