...
class FStaEbeCam(val schema: String, val sourceSchema: String, override val campaigns: Seq[String])
  ...
  override val updatePath: String =
    "pe/com/belcorp/datalake/resources/analytics/dwh/FStaEbeCam/update.sql"
  override val name: String = "dwh_fstaebecam"
  override val primaryKeys: Seq[String] = Seq(
    "CODPAIS", "ANIOCAMPANA", "CODCANALVENTA", "CODEBELISTA")
